...
<div class="pageTitle">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6">
        <div class="breadCrumb"><a href=index1.php>Home</a>/<span>My Pending Ads</span></div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-md-3 col-sm-4">
        <ul class="usernavdash">
          ...
          <li class="active"><a href="pending-ads.php"><i class="fa fa-desktop" aria-hidden="true"></i> My Pending Ads</a></li>
          <li><a href="active-ads.php"><i class="fa fa-laptop" aria-hidden="true"></i> My Active Ads</a></li>
                ...
                <div class="jobinfo">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5 text-right">
                      ...
                      <a href="ad-post1.php" class="editad"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit this ad</a> <span class="pendingad">Pending</span> </div>
                      <div class="col-md-4 col-sm-5 text-right"> <br>
                      <a href="deletead.php" class="deletead"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Delete this ad</a>
                    </div>
                  </div>
                </div>
              </div>
